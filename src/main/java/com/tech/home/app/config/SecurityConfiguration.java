package com.tech.home.app.config;

import com.tech.home.app.security.AuthoritiesConstants;
import com.tech.home.app.security.SecurityUtils;
import com.tech.home.app.security.oauth2.AudienceValidator;
import com.tech.home.app.security.oauth2.CustomClaimConverter;
...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, MvcRequestMatcher.Builder mvc) throws Exception {
        ...
        if (env.acceptsProfiles(Profiles.of(AppConstant.SPRING_PROFILE_DEVELOPMENT))) {
            http
