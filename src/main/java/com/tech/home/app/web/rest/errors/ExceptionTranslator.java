package com.tech.home.app.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private String getCustomizedErrorDetails(Throwable err) {
        ...
        if (activeProfiles.contains(AppConstant.SPRING_PROFILE_PRODUCTION)) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.tech.home.app");
    }
}
